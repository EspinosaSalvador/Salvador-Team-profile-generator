...
<div class="bg-white">
  <div class="mx-auto max-w-2xl py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
    <h2 class="text-2xl font-bold tracking-tight text-gray-900">${employee.getRole()}</h2>
      ...
      <div class="group relative">
        ...
        <div class="mt-4 flex justify-between">
          <div>
            ...
            <p class="mt-1 text-sm text-gray-500">${employee.getName()}</p>
          </div>
          <p class="text-sm font-medium text-gray-900">${employee.getId()}</p>
        </div>
          </div>
          <p class="text-sm font-medium text-gray-900">${employee.getId()}</p>
        </div>
